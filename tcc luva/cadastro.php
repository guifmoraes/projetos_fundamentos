                ...
                <div class="column is-4 is-offset-4">
                    ...
                    ?>
                        <div class="notification is-success">
                            ...
                            <p>Faça Login informando seu usuario/email e senha <a href="loginPage.php">aqui</p>
                        </div>
                    <?php
                        endif;
                    ...
                    <div class="box">
                        <form action="cadastrar.php" method="POST">
                            ...
                            <div class="field">
                                <div class="control">
                                    <input name="email" type="text" class="input is-large" placeholder="Seu melhor email" autofocus>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                            ...
                            <p>Já possui um cadastro?<a href="loginPage.php"> Clique aqui!</a></p>
                        </form>
                    </div>
                </div>
            </div>
